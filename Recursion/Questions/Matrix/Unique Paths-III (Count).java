...
class UniquePathsIIICount
{
    ...
    static int maze(int cr, int cc, int dr, int dc, boolean visited[][])
    {
        /*
        Invalid cases :
        ...
        */
        ...
        int U = maze(cr - 1, cc, dr, dc, visited);
        int D = maze(cr + 1, cc, dr, dc, visited);
        int L = maze(cr, cc - 1, dr, dc, visited);
        int R = maze(cr, cc + 1, dr, dc, visited);
    ...
    public static void main(String args[])
    {
        ...
        System.out.println("Paths count : " + maze(p[0], p[1], p[2], p[3], visited));
    }
}